...
public class PreferenceConfiguration {
    ...
    // The 3d room cells in that grid. Defined here rather than in the renderer
    // so the 2d side can recognise them without reaching into it.
    public static final int VR_ENV_MINIMAL_ROOM = 6;
    public static final int VR_ENV_PSX_CINEMA = 7;
